...
The pipeline ingests raw Netflix data, processes it using the **Medallion Architecture (Bronze → Silver → Gold)**, enforces **data quality rules**, and follows modern **data engineering best practices**.
...
## ⚙️ Databricks & Delta Live Tables (DLT)
